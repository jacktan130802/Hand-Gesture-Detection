...
train_dir = os.path.join('C:/Python/rps/datasets/train') #change to ur own directory.
test_dir = os.path.join('C:/Python/rps/datasets/test') #change to ur own directory.
